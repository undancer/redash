...
XINNIUREN_CLIENT_ID = os.environ.get("REDASH_XINNIUREN_CLIENT_ID", "")
XINNIUREN_CLIENT_SECRET = os.environ.get("REDASH_XINNIUREN_CLIENT_SECRET", "")
XINNIUREN_OAUTH_ENABLED = bool(XINNIUREN_CLIENT_ID and XINNIUREN_CLIENT_SECRET)
